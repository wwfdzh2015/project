...
<table id='problemset' width='90%'class='table table-striped table-line'>
<thead>
<tr class='toprow'>
<th width='5'></th>
<th width='120'style="cursor:pointer"><a><?php echo $MSG_PROBLEM_ID?></a></th>
<th style="cursor:pointer"><a><?php echo $MSG_TITLE?></a></th>
<th width='10%'style="cursor:pointer"><a><?php echo $MSG_SOURCE?></a></th>
<th style="cursor:pointer" width=60 ><a><?php echo $MSG_AC?></a></th>
<th style="cursor:pointer" width=60 ><a><?php echo $MSG_SUBMIT?></a></th>
</tr>
</thead>
<tbody>
<?php
