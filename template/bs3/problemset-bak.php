...
<table>
<tr align='center' class='evenrow'><td width=1%></td>
<td  colspan='1'>
<form class=form-inline action=problem.php> <!--id 查找-->
...
<table id='problemset' width='90%'class='table-line table table-striped'>
<thead>
<tr class='toprow'>
<th width='5'></th>
<th width='80' ><a><?php echo $MSG_PROBLEM_ID?></a></th>
<th ><a><?php echo $MSG_TITLE?></a></th>
<th width='10%'><a><?php echo $MSG_SOURCE?></a></th>
<th width=60 ><a><?php echo $MSG_AC?></a></th>
<th width=60 ><a><?php echo $MSG_SUBMIT?></a></th>
</tr>
</thead>
<tbody>
<?php
