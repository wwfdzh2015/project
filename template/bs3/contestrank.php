...
<table id=rank><thead><tr class='toprow' align=center><td class="{sorter:'false'} " width=5%>Rank<th width=10% style="cursor:pointer"><a>User</a></th><th width=10% style="cursor:pointer"><a>Nick</a></th><th width=5% style="cursor:pointer"><a>Solved</a></th><th width=5% style="cursor:pointer"><a color:#eeeeee>Penalty</a></th>
<?php
for ($i=0;$i<$pid_cnt;$i++)
echo "<td><a href=problem.php?cid=$cid&pid=$i>$PID[$i]</a></td>";
echo "</tr></thead>\n<tbody>";
for ($i=0;$i<$user_cnt;$i++){
if ($i&1) echo "<tr class='oddrow table-line' align=center>\n";
else echo "<tr class='evenrow table-line' align=center>\n";
echo "<td>";
$uuid=$U[$i]->user_id;
$nick=$U[$i]->nick;
if($nick[0]!="*")
